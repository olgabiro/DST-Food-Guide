...
export const HAMLET_DISHES: Dish[] = [
  ...
  { name: 'Meated Fire Nettle', hungerValue: 37.5, sanityValue: -5, healthValue: 20, requirements: '2 Units of Fire Nettle Fronds and 1 Unit of Meat. Can\'t have more than 1 Unit of Monster Food or Inedible.', effects: 'Warms the body.', cookingStation: "crockPot", image: "nettlemeated.png" },
